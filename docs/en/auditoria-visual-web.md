...
Section tabs now share `AppSectionTabs`: a subtle web container, rounded red selection, hover/focus states and horizontal scrolling, aligned with the start of the content. Native TabBar parameters and existing controllers remain intact. The migration covers Connections, Knowledge, Labels, Profile, Explore, administration sections and editors. The 739-test suite passes with one skipped; Connections was visually inspected.
