...
/// Respuesta de `POST /api/accounts/github/device-code`: código que el
/// usuario debe introducir en [verificationUri] para autorizar el acceso.
...
/// Resultado de sondear `POST /api/accounts/github/device-token`.
